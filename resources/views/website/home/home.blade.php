...
<section>
    <div class="hero-slider position-relative">
        ...
        <div class="hero-slider-item py-160" style="background-image: url({{ asset('/') }}website/images/banner/banner-3.jpg);"
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                ...
                <h2 class="section-title section-title-border">All letest resent blog</h2>
            </div>
            <!-- service item -->
            ...
            <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                <div class="card text-center">
                    ...
                    <div class="card-img-wrapper">
                        <img class="card-img-top rounded-0" src="{{ asset($recent_blog->image) }}"
                            alt="service-image">
                    </div>
        ...
        <div class="row">
            <div class="col-lg-6 ml-auto">
                <div class="rounded p-sm-5 px-3 py-5 bg-secondary">
                    ...
                    <p class="text-white mb-40">Excepteur sint occaecat cupidatat non proident sunt culpa qui
                ...
                <div id="accordion" class="mb-md-50">
                    <div class="card border-0 mb-4">
                        <div class="card-header bg-gray border p-0">
                            <a class="card-link h5 d-block text-dark mb-0 py-10 px-4" data-toggle="collapse"
                                href="#collapseOne">
                    ...
                    <div class="card border-0 mb-4">
                        <div class="card-header bg-gray border p-0">
                            <a class="collapsed card-link h5 d-block text-dark mb-0 py-10 px-4"
            ...
            <div class="col-lg-7 col-md-7 align-self-center pl-0">
                <div class="testimonial-slider p-5">
                    ...
                    <div class="outline-0">
                        ...
                        <p class="text-dark">Lorem ipsum dolor sit amet constur adipisicing elit sed eiusmtempor
                            incid sed dolore magna aliqu enim minim veniam quis nostrud exercittion ullamco labo ris
                            nisi aliquip excepteur.</p>
...
<section class="cta overlay-primary py-50 text-center text-lg-left"
    style="background-image: url({{ asset('/') }}website/images/background/cta.jpg);">
    <div class="container">
